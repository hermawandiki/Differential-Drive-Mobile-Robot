...
SERVER_URL = 'http://192.168.158.150:5000' 
sio = Client()
...
def send_to_server(data):
    sio.emit('msg', data)
    # canvas.itemconfig(led, fill="#59FF00")
...
def button_1_clicked():
    # print("Mode Manual PWM")
    send_to_server("P")
    canvas.itemconfig(current_mode, text="Test Motor")
def button_2_clicked():
    # print("Mengikuti Dinding")
    send_to_server("W")
    canvas.itemconfig(current_mode, text="Wall Following")
def button_3_clicked():
    # print("Jalan Otomatis")
    send_to_server("A")
...
#     window.after(100, blink_rectangle)
